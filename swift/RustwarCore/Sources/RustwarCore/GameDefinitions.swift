public enum GameDefinitions {
    ...
    public static let buildings: [BuildingType: BuildingDefinition] = [
        ...
        .landFactory: BuildingDefinition(type: .landFactory, name: "Land Factory", icon: "LF", hitPoints: 920, size: 76, metalCost: 620, buildTime: 22, income: 0, supply: 8, vision: 310, produces: [.scout, .tank]),
