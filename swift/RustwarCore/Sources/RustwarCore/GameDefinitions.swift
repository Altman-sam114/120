public enum GameDefinitions {
    ...
    public static let buildings: [BuildingType: BuildingDefinition] = [
        ...
        .turret: BuildingDefinition(type: .turret, name: "Turret", icon: "TR", hitPoints: 650, size: 48, metalCost: 330, income: 0, supply: 0, vision: 330, attackRange: 230, damage: 28, reloadTime: 1.2)
    ]
