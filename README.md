...
- 红方 AI：会用空闲 Builder 在空闲资源点建造 Extractor，在缺少陆军工厂或已有基础经济后建造未完成 Land Factory，在基地周边建造未完成 Turret，用已有资源在完成状态红方陆军工厂排队生产 Scout / Light Tank，并让空闲战斗单位主动攻击最近的玩家单位或建筑。
