...
- 外接键盘：Space 回到己方 Command Center，P 暂停/恢复，R 重开当前地图，E 选择空闲 Builder，Control + A 选择全部战斗单位，Option + A 选择同类型单位，A 进入 Attack Move，G 进入 Patrol，H 进入 Guard，C 进入 Reclaim，S 停止或取消当前等待命令。
- 拖拽：平移战场视角。
- 捏合：缩放战场视角。
