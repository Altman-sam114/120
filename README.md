...
- Save 1-9 / Group 1-9：保存或召回 1-9 号控制编队；召回会过滤已死亡、缺失或非己方目标，并恢复为当前多选集合。
- 拖拽：平移战场视角。
- 捏合：缩放战场视角。
