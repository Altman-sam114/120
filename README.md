...
- Idle Builders：选择全部空闲己方 Builder，并在主战场和战术小地图高亮多选集合；Move、Attack Move、Patrol、Guard、Repair 和 Stop 会作用于所有可执行该命令的选中己方单位，其它命令仍沿用 primary selection 单单位语义。
