...
- v1.67 只补齐多 Builder Repair 的动态分散接近点；Reclaim / Build 仍保持各自既有多选语义，尚无完整队形保持、碰撞避让、寻路、Shift 队列、运输语义、完整雾/雷达、沙盒或完整 Web parity。
