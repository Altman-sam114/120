...
- v1.66 只补齐多单位 Guard 的方阵护航偏移；Repair / Reclaim / Build 仍保持各自既有多选语义，尚无完整队形保持、碰撞避让、寻路、Shift 队列、运输语义、完整雾/雷达、沙盒或完整 Web parity。
