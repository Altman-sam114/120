...
flowchart TD
  ...
  C --> LAY["RootGameView geometry + safe-area partition<br/>中文注释：先把高度 <520 的横屏识别为 compact trailing，再判断 >=700 regular trailing、560-699 横屏 compact trailing、其余 compact bottom；短横屏 dock 为 224-260pt 单列"]
