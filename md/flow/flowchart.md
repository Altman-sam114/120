...
flowchart TD
  ...
  TF --> E
  E --> AI["Enemy AI<br/>中文注释：红方 Builder 维修受损友军、扩张资源点、建造 Land Factory / Turret 并回收附近残骸，红方完成状态工厂按完整 T1 列表排队造兵，空闲战斗单位获得攻击玩家目标的订单"]
  AI --> E
  C --> E
