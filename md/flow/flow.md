...
RustwarCore MapPreset / GameState / GameEngine
  ...
  -> GameEngine turret defensive fire targets units/buildings and enemy AI expands resource nodes, builds Land Factories and Turrets, queues production and attack orders
```
