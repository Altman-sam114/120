...
RustwarCore MapPreset / GameState / GameEngine
  ...
  -> VisibilitySnapshot current and explored tiles for SpriteKit battlefield fog / tactical map fog overlay and enemy entity render filtering; CameraState visible rect renders tactical map viewport frame and tactical map drag camera
```
