...
- 计算收入、人口、简单 tick、实体/残骸/资源点命中选择、己方单单位和多单位移动、己方单单位和多单位 Attack-Move、己方单单位和多单位 Patrol、己方单单位和多单位 Guard、己方单 Builder 和多 Builder Repair、己方单 Builder 和多 Builder Reclaim、己方单 Builder 和多 Builder 建造 Extractor、己方单 Builder 和多 Builder 建造 Turret、己方单 Builder 和多 Builder 建造 Land Factory、己方单单位和多单位 Stop、己方单单位攻击、炮塔自动防御开火、基础伤害/死亡残骸清理、Command Center Builder 生产、Land Factory T1 生产队列、生产取消/退款、重复生产、己方生产建筑集结点设置、红方最小生产/资源扩张/维修/回收/Land Factory 建造/Turret 建造/进攻 AI、红方 AI Web-lite 目标评分，以及从已保存 `GameState` 恢复 `GameEngine`。
